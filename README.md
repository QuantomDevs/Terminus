...
![GitHub Repo stars](https://img.shields.io/github/stars/Snenjih/Terminus?style=flat&label=Stars)
![GitHub forks](https://img.shields.io/github/forks/Snenjih/Terminus?style=flat&label=Forks)
![GitHub Release](https://img.shields.io/github/v/release/Snenjih/Terminus?style=flat&label=Release)
...
<br />
<p align="center">
  <a href="https://github.com/Snenjih/Terminus">
    <img alt="Terminus Banner" src=./repo-images/HeaderImage.png style="width: auto; height: auto;">  </a>
</p>

If you would like, you can support the project here!\
[![GitHub Sponsor](https://img.shields.io/badge/Sponsor-SnenjihGus-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/sponsors/SnenjihGus)

# Overview

<p align="center">
  <a href="https://github.com/Snenjih/Terminus">
    <img alt="Terminus Banner" src=./public/icon.svg style="width: 250px; height: 250px;">  </a>
</p>

Terminus is an open-source, forever-free, self-hosted all-in-one server management platform. It provides a web-based
solution for managing your servers and infrastructure through a single, intuitive interface. Terminus offers SSH terminal
...
See [Projects](https://github.com/orgs/Snenjih/projects/2) for all planned features. If you are looking to contribute, see [Contributing](https://github.com/Snenjih/Terminus/blob/main/CONTRIBUTING.md).
...
Visit the Terminus [Docs](https://docs.terminus.site/install) for more information on how to install Terminus on all platforms. Otherwise, view
a sample Docker Compose file here:

```yaml
services:
  terminus:
    image: ghcr.io/Snenjihgus/terminus:latest
...
If you need help or want to request a feature with Terminus, visit the [Issues](https://github.com/Snenjih/Support/issues) page, log in, and press `New Issue`.
...
<p align="center">
  <img src="./repo-images/Image 1.png" width="400" alt="Terminus Demo 1"/>
  <img src="./repo-images/Image 2.png" width="400" alt="Terminus Demo 2"/>
</p>

<p align="center">
  <img src="./repo-images/Image 3.png" width="400" alt="Terminus Demo 3"/>
  <img src="./repo-images/Image 4.png" width="400" alt="Terminus Demo 4"/>
</p>

<p align="center">
  <img src="./repo-images/Image 5.png" width="400" alt="Terminus Demo 5"/>
  <img src="./repo-images/Image 6.png" width="400" alt="Terminus Demo 6"/>
</p>

<p align="center">
  <img src="./repo-images/Image 7.png" width="400" alt="Terminus Demo 7"/>
</p>
